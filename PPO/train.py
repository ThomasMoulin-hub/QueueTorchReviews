...
def policy(args1, args2):
    config_file_name = args1 
    env_config_name = args2
    ...
    config_file_path = "/user/xz3355/QueueTorchReviews/PPO/configs/" + config_file_name
    with open(config_file_path, 'r') as f:
        config = yaml.safe_load(f)
    
    print(f'env_config: {env_config_name}')

    with open(f'/user/xz3355/QueueTorchReviews/configs/env/{env_config_name}.yaml', 'r') as f:
